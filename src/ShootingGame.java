...
public class ShootingGame extends JFrame {
    ...
    public boolean isMainScreen, isLoadingScreen, isGameScreen, isEndScreen;
    ...
    private void gameStart(){
        game.username = JOptionPane.showInputDialog(this, "Type your id : ");

        //로딩, 게임 화면을 넘어가기 위한 메소드
        isMainScreen=false;
    ...
    public void paint(Graphics g){
        ...
        screenGrapic=bufferImage.getGraphics();
